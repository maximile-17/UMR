 ...
 * Send Gather Receive Scatter use buf_sg mr
 * Memcory Copy use buf_sg(buf_cp copy to buf_sg) mr 
 * User-model Memory Registration use buf_umr emr[mr_num]->modify_mr
 */
