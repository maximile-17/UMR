...
NODE="--map-by node"
SGRS_UMR=/home/mxx/ddt_direct/UMR-master/sgrs_umr_stencil

scp /home/mxx/ddt_direct/UMR-master/sgrs_umr_stencil suse108:/home/mxx/ddt_direct/UMR-master/
...
#done
for block_num in 3 5 7 9 11 13 15
do 
$OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $SGRS_UMR -E 1 -b $block_num -n $block_num -s $block_num -W 1000 -N 10000 
done

#$OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $SGRS_UMR -E 1 -b 10 -n 5 -s 5 -W 1000 -N 10000 
