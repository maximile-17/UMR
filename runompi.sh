...
NODE="--map-by node"
SGRS_UMR=/home/mxx/ddt_direct/sgrs_umr_IE/sgrs_umr

scp /home/mxx/ddt_direct/sgrs_umr_IE/sgrs_umr suse108:/home/mxx/ddt_direct/sgrs_umr_IE/
...
do
$OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $SGRS_UMR -E 1 -b $block_size -n 16 -s $[1024*1024*16] -W 100 -N 1000
done
#$OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $SGRS_UMR -E 1 -b 4 -n 4 -s 6 -W 0 -N 1 -d
#
