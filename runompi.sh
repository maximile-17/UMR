...
#done
for block_size in 256 1024 4096 16384 65536 $[65536*4] 
do
  for block_num in 16 32 64 128 256 512 1024 2048 4096 
  do 
  $OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $1 -E 1 -b $block_size -n $block_num -s $[$block_size*2] -W 1000 -N 10000
  done
done
