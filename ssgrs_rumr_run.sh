...
NODE="--map-by node"
SGRS_UMR=/home/mxx/ddt_direct/UMR-master/ssgrs_rumr_largelist 

scp /home/mxx/ddt_direct/UMR-master/ssgrs_rumr_largelist suse108:/home/mxx/ddt_direct/UMR-master/
...
for block_size in 32 256 1024 4096 16384 65536 
do 
for block_num in 16 32 64 128 256 512 1024
do
$OMPI_PATH/bin/mpirun -np 2 -hostfile $HOSTFILE $NODE $BIND $ROOT $SGRS_UMR -E 1 -b $block_size -n $block_num -s $[$block_size*2] -W 1000 -N 10000 
done
done
